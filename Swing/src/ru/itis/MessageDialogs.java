package ru.itis;// Lexiya1.MessageDialogs.java
...
public class MessageDialogs extends JFrame {
    ...
    public MessageDialogs() {
        ...
        message2.addActionListener(myListener);
        
        JButton message3 = new JButton("5 параметров");
        
        message3.addActionListener(e -> JOptionPane.showMessageDialog(
                MessageDialogs.this,
